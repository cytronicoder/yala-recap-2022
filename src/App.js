        ...
        <div className="App-letter-container">
          <div className="letter-container">
            ...
            <p className="App-description">
              We want to share a big thank you for one of the <span className="hover-underline-animation">180+ scholars</span> from <span className="hover-underline-animation">14+ countries</span> in our 5th-ever YALA Camp, also the first in-person camp since the pandemic in 2022.
            ...
            <p className="App-description">
              ...
              Thanks again for joining us, and we hope to see you again <span className="hover-underline-animation">in 2023!</span>
            </p>
          ...
          <Marquee velocity={12}>
            {times(10, Number).map(id => (
              <p key={id} className="App-rolling-text-content">
                Thanks a lot for joining us, and we hope to see you again in 2023!
              </p>
            ))}
          </Marquee>
        </div>
